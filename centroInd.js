var escentroid= function() {
  ...
  t=t+'</div>',
  t=t+'</li>',
  t=t+'<li><img src="imagens/caixa.jpg" width="150px" height="150px" />',
  ...
  t=t+'</div>',
  t=t+'</li>',
  t=t+'<li><img src="imagens/kitchop.jpg" width="150px" height="150px" />',
  ...
  t=t+'</div>',
  t=t+'</li>',
  t=t+'<li><img src="imagens/som.jpg" width="150px" height="150px" />',
